                    ...
                    <div class="table-responsive col-md-10">
                        <table id="permissions-table" class="table table-condensed table-permissions table-checkboxes">
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" value="1" checked name="permissions[admin.{!! $module !!}.store]"  class="icheckbox_square-grey checked"></td>
                                <td><input type="checkbox" value="1" checked name="permissions[admin.{!! $module !!}.edit]"  class="icheckbox_square-grey checked"></td>
                                <td><input type="checkbox" value="1" checked name="permissions[admin.{!! $module !!}.update]"  class="icheckbox_square-grey checked"></td>
