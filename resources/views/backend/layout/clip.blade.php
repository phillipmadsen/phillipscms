...
@if ($user = Sentinel::getUser())
    ...
    <div class="alert alert-success">has admin</div>
    @endif
@endif

@if (Sentinel::hasAnyAccess(['admin']))
   <div class="alert alert-success">The user has permission</div>
@else
   <div class="alert alert-error">The permission check failed</div>
@endif
